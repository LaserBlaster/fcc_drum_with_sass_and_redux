    ...
    render() {
        ...
        return (
            ...
            <div id="drum-machine" className={this.state.drumBody} /*class="container" style={this.state.mainContainer}*/ > 
                <div className={this.state.bigGrid}>
                    <div className={this.state.bigGridItem1}>
                        <div id="buttons" className="grid-container" >
                            <div className="item1 drum-pad" id={this.state.qValue} >
                                <audio className="clip" id="Q" src={this.state.qLink}></audio>
                                Q
                            </div>
                            <div className="item2 drum-pad" id={this.state.wValue}>
                                <audio className="clip" id="W" src={this.state.wLink}></audio>  
                                W                            
                            </div>
                            <div className="item3 drum-pad" id={this.state.eValue}>
                                <audio className="clip" id="E" src={this.state.eLink}></audio>        
                                E                      
                            </div>
                            <div className="item4 drum-pad" id={this.state.aValue}>
                                <audio className="clip" id="A" src={this.state.aLink}></audio>    
                                A                         
                            </div>
                            <div className="item5 drum-pad" id={this.state.sValue}>
                                <audio className="clip" id="S" src={this.state.sLink}></audio>       
                                S                       
                            </div>
                            <div className="item6 drum-pad" id={this.state.dValue}>
                                <audio className="clip" id="D" src={this.state.dLink}></audio>         
                                D                      
                            </div>
                            <div className="item7 drum-pad" id={this.state.zValue}>
                                <audio className="clip" id="Z" src={this.state.zLink}></audio>   
                                Z                           
                            </div>
                            <div className="item8 drum-pad" id={this.state.xValue}>
                                <audio className="clip" id="X" src={this.state.xLink}></audio>          
                                X                    
                            </div>
                            <div className="item9 drum-pad" id={this.state.cValue}>
                                <audio className="clip" id="C" src={this.state.cLink}></audio>          
                                C                   
                            </div>
                        </div>
                    </div>
                    <div className={this.state.bigGridItem2}>
                        <div id="controls" className="grid-container2">   
                            <div id="powerSection" className="grid2-item1" style={{backgroundColor: this.state.color}}>
                                <h2 id="powerLabel" style={{backgroundColor: this.state.color}}>Power</h2>
                                <div id="powerButton" className={this.state.powerClass} />                                       
                            </div>
                            ...
                            <div className="grid2-item4">
                                <input id="volumeControl" type="range" min="0" max="100" step="1" onInput={this.setVolume} onChange={this.setVolume}></input>
                            </div>
                            <div className="grid2-item5">
                                <div id="currentInstrument" className="grid2-item2">{this.state.instrument}</div>
                            </div>
                            <div className="grid2-item6">
                                <div className="container" >
                                    <div className="row" >
                                        <div className="col-lg-12" >
                                            <div className="btn-group" >
                                                <button id="instrumentDropdownMenu" type="button" className="btn btn-default dropdown-toggle border-0" data-toggle="dropdown" style={{fontSize: "1.2em"}}/*style={{width: "10em", marginLeft: "-1em" }} */>Scrollable Menu <span class="caret"></span></button>
                                                <ul className="dropdown-menu scrollable-menu" role="menu" style={{width: "12em",height: "7em", overflowY: "scroll", backgroundColor: "black", marginTop: "-0.1em"}}>
                                                    <li><a className="dropdown-item" id="drums" onClick={this.setInstrument}>Drums</a></li>
                                                    <li><a className="dropdown-item" id="piano" onClick={this.setInstrument}>Piano</a></li>
                                                    <li><a className="dropdown-item" id="flute" onClick={this.setInstrument}>Flute</a></li>
